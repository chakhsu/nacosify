...
var ConfigSide = /** @class */ (function () {
    function ConfigSide(client) {
        this.client = client;
    }
    ConfigSide.prototype.get = function (id, group, options) {
        if (group === void 0) { group = DEFAULT_GROUP; }
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.getConfig(id, group, options)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    ConfigSide.prototype.getMore = function (ids, group, options) {
        if (group === void 0) { group = DEFAULT_GROUP; }
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var configs;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.map(ids, function (id) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.get(id, group, options)];
                                        case 1:
                                            config = _a.sent();
    ...
    ConfigSide.prototype.subscribe = function (obj, listener) {
        var reg = getReg(obj);
        return this.client.subscribe(reg, listener);
    };
    ConfigSide.prototype.unSubscribe = function (obj, listener) {
        var reg = getReg(obj);
